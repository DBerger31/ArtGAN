...
def define_generator(latent_dim, n_classes=10):
    ...
    n_nodes = 4 * 4  # we need this number to be a factor of the image dimensions
    li = Dense(n_nodes)(li)
    li = Reshape((4, 4, 1))(li)
    ...
    # output
    out_layer = Conv2D(3, (4,4), activation='tanh', padding='same')(gen) #64x64x3
    # define model
...
model = load_model('10_mod.h5',compile=False)
